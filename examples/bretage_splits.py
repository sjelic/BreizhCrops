...
np.save('../data/X_01.npy', X_01)
np.save('../data/X_02.npy', X_02)
np.save('../data/X_03.npy', X_03)
np.save('../data/X_04.npy', X_04)

np.save('../data/y_01.npy', y_01)
np.save('../data/y_02.npy', y_02)
np.save('../data/y_03.npy', y_03)
np.save('../data/y_04.npy', y_04)
